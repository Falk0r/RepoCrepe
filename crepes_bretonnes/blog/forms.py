...
class ContactForm(forms.Form):
    ...
    def clean_message(self):
        ...
        if "pizza" in message:
            raise forms.ValidationError("On ne veut pas entendre parler de pizza ici !")
    ...
    def clean(self):
        ...
        if sujet and message: #Est-ce que sujet et message sont valides ?
            if "pizza" in sujet and "pizza" in message:
                raise forms.ValidationError("Vous parlez de pizzas dans le sujet ET le message ? Non mais oh !")
